...
// mongodb 连接?
mongoose.connect(setting.password? `mongodb://${setting.user}:${setting.password}@${setting.host}:${setting.port}/${setting.database}`:`mongodb://${setting.host}:${setting.port}/${setting.database}`)
